...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scene.scene_start_time'
        db.alter_column('story_scene', 'scene_start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Scene.scene_end_time'
        db.alter_column('story_scene', 'scene_end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Scene.scene_start_time'
        db.alter_column('story_scene', 'scene_start_time', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Scene.scene_end_time'
        db.alter_column('story_scene', 'scene_end_time', self.gf('django.db.models.fields.DateField')(null=True))
