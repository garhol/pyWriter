...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scene.scene_start_time'
        db.add_column('story_scene', 'scene_start_time',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scene.scene_end_time'
        db.add_column('story_scene', 'scene_end_time',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scene.scene_start_time'
        db.delete_column('story_scene', 'scene_start_time')

        # Deleting field 'Scene.scene_end_time'
        db.delete_column('story_scene', 'scene_end_time')
    ...
    models = {
        ...
        'story.scene': {
            ...
            'scene_end_time': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'scene_start_time': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
