...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scene.word_target'
        db.add_column('story_scene', 'word_target',
                      self.gf('django.db.models.fields.IntegerField')(default=1000, blank=True),
                      keep_default=False)

        # Adding field 'Scene.word_count'
        db.add_column('story_scene', 'word_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scene.word_target'
        db.delete_column('story_scene', 'word_target')

        # Deleting field 'Scene.word_count'
        db.delete_column('story_scene', 'word_count')
