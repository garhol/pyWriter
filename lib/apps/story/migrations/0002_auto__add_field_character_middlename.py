...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.middlename'
        db.add_column('story_character', 'middlename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.middlename'
        db.delete_column('story_character', 'middlename')
