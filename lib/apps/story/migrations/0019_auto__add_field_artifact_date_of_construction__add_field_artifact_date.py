...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artifact.date_of_construction'
        db.add_column('story_artifact', 'date_of_construction',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artifact.date_of_destruction'
        db.add_column('story_artifact', 'date_of_destruction',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.date_of_construction'
        db.add_column('story_location', 'date_of_construction',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.date_of_destruction'
        db.add_column('story_location', 'date_of_destruction',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artifact.date_of_construction'
        db.delete_column('story_artifact', 'date_of_construction')

        # Deleting field 'Artifact.date_of_destruction'
        db.delete_column('story_artifact', 'date_of_destruction')

        # Deleting field 'Location.date_of_construction'
        db.delete_column('story_location', 'date_of_construction')

        # Deleting field 'Location.date_of_destruction'
        db.delete_column('story_location', 'date_of_destruction')
