...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Story.registered_access'
        db.add_column('story_story', 'registered_access',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Story.public_access'
        db.add_column('story_story', 'public_access',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.registered_access'
        db.delete_column('story_story', 'registered_access')

        # Deleting field 'Story.public_access'
        db.delete_column('story_story', 'public_access')
