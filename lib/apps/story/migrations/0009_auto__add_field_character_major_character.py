...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.major_character'
        db.add_column('story_character', 'major_character',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.major_character'
        db.delete_column('story_character', 'major_character')
