...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Story.genre'
        db.add_column('story_story', 'genre',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['story.Genre'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Story.fiction'
        db.add_column('story_story', 'fiction',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.genre'
        db.delete_column('story_story', 'genre_id')

        # Deleting field 'Story.fiction'
        db.delete_column('story_story', 'fiction')
