...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scene.importance'
        db.add_column('story_scene', 'importance',
                      self.gf('django.db.models.fields.CharField')(default='SP', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scene.importance'
        db.delete_column('story_scene', 'importance')
