...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scene.status'
        db.add_column('story_scene', 'status',
                      self.gf('django.db.models.fields.CharField')(default='OL', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scene.status'
        db.delete_column('story_scene', 'status')
